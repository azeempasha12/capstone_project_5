...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 md:top-3 md:left-5 lg:top-5 lg:left-4 lg:max-w-[20">
      <div className="w-full md:w-[80px] h-auto md:h-[710px] lg:h-[800px] bg-red-300 border-4 border-blue-400 md:rounded-3xl rounded-t-none flex flex-row md:flex-col justify-around items-center md:justify-start md:items-start">
        ...
        <button className="m-2 md:m-4 lg:mt-80 p-1 border-2 border-green-500 rounded-full bg-white">
          {isLoggedIn ? (
            <img
              src="/assets/images.jpeg"
              alt="User Profile"
              className="h-8 w-8 md:h-8 md:w-10 rounded-full object-cover"
