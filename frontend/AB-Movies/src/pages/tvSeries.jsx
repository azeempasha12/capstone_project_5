...
//   const handleRemoveBookmark = (show) => {
//     const existingBookmarks = JSON.parse(localStorage.getItem('bookmarkedTVShows')) || [];
//     const updatedBookmarks = existingBookmarks.filter(bookmarkedShow => bookmarkedShow.id !== show.id);
//     localStorage.setItem('bookmarkedTVShows', JSON.stringify(updatedBookmarks));
//   };
...
//       <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
//         {filteredTvShows.map(show => (
//           <div key={show.id} className="bg-white rounded-lg shadow-md overflow-hidden relative group">
//             {show.poster_path && (
//               <div className="relative overflow-hidden">
//                 <img
//                   src={`https://image.tmdb.org/t/p/w500${show.poster_path}`}
...
//                 </button>
//                 <button
//                   className="absolute top-10 right-2 bg-white rounded-full p-2 shadow-md hover:bg-gray-200 z-10"
//                   onClick={(e) => {
//                     e.stopPropagation();
//                     handleRemoveBookmark(show);
//                   }}
//                 >
